...
print(f"-------------------------")
print(f"Khan: {khan_percent:.2%} ({khan_total})")
print(f"Correy: {correy_percent:.2%} ({correy_total})")
print(f"Li: {li_percent:.2%} ({li_total})")
print(f"O'Tooley: {o_tooley_percent:.2%} ({o_tooley_total})")
print(f"-------------------------")
...
with open(poll_file, "w") as outfile:
    ...
    outfile.write("-------------------------\n")
    outfile.write(f"Khan: {khan_percent:.2%} ({khan_total})\n")
    outfile.write(f"Correy: {correy_percent:.2%} ({correy_total})\n")
    outfile.write(f"Li: {li_percent:.2%} ({li_total})\n")
    outfile.write(f"O'Tooley: {o_tooley_percent:.2%} ({o_tooley_total})\n")
    outfile.write("-------------------------\n")
